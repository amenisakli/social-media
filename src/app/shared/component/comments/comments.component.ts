...
import { Component, EventEmitter, Input, Output, Query } from '@angular/core';
import { FormBuilder, FormControl, Validators } from '@angular/forms';
import { Comment } from 'src/app/core/model/comments.model';
...
@Component({
  ...
  animations: [
    trigger('list', [
      transition(':enter', [
        query('@listItem', [stagger(200, [animateChild()])]),
      ]),
    ]),
    trigger('listItem', [
      state(
